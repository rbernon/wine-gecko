...
latex_documents = [
  ('index', 'BrowserMobProxy.tex', 'BrowserMob Proxy Documentation',
   'David Burns', 'manual'),
]
...
man_pages = [
    ('index', 'browsermobproxy', 'BrowserMob Proxy Documentation',
     ['David Burns'], 1)
]
...
texinfo_documents = [
  ('index', 'BrowserMobProxy', 'BrowserMob Proxy Documentation',
   'David Burns', 'BrowserMobProxy', 'One line description of project.',
   'Miscellaneous'),
]
