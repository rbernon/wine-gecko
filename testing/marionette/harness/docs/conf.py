...
latex_documents = [
  ('index', 'MarionettePythonClient.tex', 'Marionette Python Client Documentation',
...
texinfo_documents = [
  ('index', 'MarionettePythonClient', 'Marionette Python Client Documentation',
   'Mozilla Automation and Tools team', 'MarionettePythonClient', 'One line description of project.',
   'Miscellaneous'),
]
