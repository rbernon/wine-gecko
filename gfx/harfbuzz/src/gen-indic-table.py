...
if len (sys.argv) != 4:
	print("usage: ./gen-indic-table.py IndicSyllabicCategory.txt IndicMatraCategory.txt Blocks.txt", file=sys.stderr)
	sys.exit (1)
...
for i,d in enumerate (data):
	for u,v in list(d.items ()):
		...
		combined[u][i] = v
combined = {k:v for k,v in list(combined.items()) if v[2] not in BLACKLISTED_BLOCKS}
data = combined
del combined
num = len (data)
